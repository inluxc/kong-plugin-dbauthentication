...
return {
  ...
  fields = {
    ...
    db_passwd = {required = true, type = "string"},
    db_user_table = {required = true, type = "string" },
    db_username_column = {required = true, type = "string"},
    db_passwd_column = {required = true, type = "string"},
    anonymous = {type = "string", default = "", func = check_user},
    cache_ttl = {required = true, type = "number", default = 60},
    hide_credentials = {type = "boolean", default = false},
    timeout = {type = "number", default = 10000},
